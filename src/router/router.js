...
export const appRouter = [
    ...
    // },
    {
        ...
        children: [
            ...
            { path: 'requisition-list', title: '领料单', access:'production-manage/requisition-list', name: 'requisition-list', icon: 'link', component: () => import('@/views/production-manage/requisition-list.vue') },
